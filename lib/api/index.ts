...
export type { CourseWithSubjects } from './models/CourseWithSubjects';
...
export type { ExamWithCourses } from './models/ExamWithCourses';
...
export { BusinessUsersService } from './services/BusinessUsersService';
